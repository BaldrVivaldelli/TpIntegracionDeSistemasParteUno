...
@if (Auth::check())		
				...
				<table id="tablaCont">
					...
					@foreach ($myFiles as $file)
							...
							<td>
							<a href="#" onclick="event.preventDefault(); document.getElementById('detail-post-{{$file->hashName}}').submit();">
								Detail
							</a>
							<form id="detail-post-{{$file->hashName}}" action="/detailsFile/{{$file->hashName}}" method="GET" style="display: none;">
								{{ csrf_field() }}
